...
import java.util.regex.Pattern;
     ...
     */
public class ExpansionHub extends LynxCommExceptionHandler implements HardwareDevice {
         ...
         */
        public ExpansionHub(LynxModule expansionHub)
        {
        ...
        public synchronized void killAnalogPower() {
            LynxConstants.validateAnalogInputZ(0);
        }
